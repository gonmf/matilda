...
optimized_program = "/home/user/go/matilda/github/src/matilda11 -d /home/user/go/matilda/github/src/data/ -m gtp --disable_opening_books --disable_score_estimation -l"
...
#
command = 'gogui-twogtp -size 11 -komi 7.5 -white ' + optimized_program + ' -black ' + opponent_program + ' -sgffile twogtp.sgf -games 1 -auto'
